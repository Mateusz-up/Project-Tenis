...
pygame.mixer.music.load(os.path.join('muzyka', 'muzyka1.mp3'))
sound_effect = pygame.mixer.Sound(os.path.join('muzyka', 'muzyka2.ogg'))


colour_1 = pygame.color.THECOLORS['black']
colour_2 = pygame.color.THECOLORS['darkgreen']
...
basic_font = pygame.font.SysFont("Arial", 120)
game_over_font_big = pygame.font.SysFont("Arial", 72)
game_over_font_small = pygame.font.SysFont("Arial", 50)
...
while True:
    ...
    score_board = basic_font.render(str(player1_score) + "           " + str(player2_score), True, colour_1, colour_2)
    score_board_rect = score_board.get_rect()
    score_board_rect.centerx = surface_rect.centerx
    score_board_rect.y = 10

    main_surface.fill(colour_2)
    ...
    pygame.draw.rect(main_surface, colour_1, (net_rect0.left, net_rect0.top, net_rect0.width, net_rect0.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect1.left, net_rect1.top, net_rect1.width, net_rect1.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect2.left, net_rect2.top, net_rect2.width, net_rect2.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect3.left, net_rect3.top, net_rect3.width, net_rect3.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect4.left, net_rect4.top, net_rect4.width, net_rect4.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect5.left, net_rect5.top, net_rect5.width, net_rect5.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect6.left, net_rect6.top, net_rect6.width, net_rect6.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect7.left, net_rect7.top, net_rect7.width, net_rect7.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect8.left, net_rect8.top, net_rect8.width, net_rect8.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect9.left, net_rect9.top, net_rect9.width, net_rect9.height))
    pygame.draw.rect(main_surface, colour_1, (net_rect10.left, net_rect10.top, net_rect10.width, net_rect10.height))
...
while True:
    ...
    if player1_win == True:
        game_over = game_over_font_big.render("Koniec Gry", True, colour_1, colour_2)
        game_over1 = game_over_font_small.render("Wygrywa zawodnik 1", True, colour_1, colour_2)
    elif player2_win == True:
        game_over = game_over_font_big.render("Koniec Gry", True, colour_1, colour_2)
        game_over1 = game_over_font_small.render("Wygrywa zawodnik 2", True, colour_1, colour_2)
